...
export const Route = createFileRoute("/qif-to-qbo")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Free QIF to QBO Converter — BalanceExtract" },
    ],
  }),
  component: Page,
});
...
function Page() {
  const steps = converterSteps("QIF", "QBO");
  const jsonLd = converterPageJsonLd({
    name: "Free QIF to QBO Converter",
    description: "Convert a Quicken QIF file into a QuickBooks-ready QBO file. Free, runs entirely in your browser — nothing uploaded.",
    url: "/qif-to-qbo",
    steps,
    faq: FAQ,
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <StatementFunnel sourceFormat="QIF" targetFormat="QBO" />

      <ArticleH2>How to convert QIF to QBO in 3 steps</ArticleH2>
      ...
      <ToolCrossLinks links={[{ href: "/qif-to-csv", label: "QIF to CSV" }, { href: "/csv-to-qif", label: "CSV to QIF" }, { href: "/qbo-to-csv", label: "QBO to CSV" }, { href: "/bank-statement-to-csv", label: "Bank Statement to CSV" }]} />
