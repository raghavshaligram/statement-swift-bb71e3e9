...
export const Route = createFileRoute("/bank-statement-to-ofx")({
  head: () => ({
    links: [{ rel: "canonical", href: `${SITE_ORIGIN}/bank-statement-to-ofx` }],
    meta: [
...
function Page() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Breadcrumbs trail={[{ label: "Bank statement converters", href: "/blog" }, { label: "Free Bank Statement to OFX Converter" }]} />
