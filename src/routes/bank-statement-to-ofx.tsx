...
export const Route = createFileRoute("/bank-statement-to-ofx")({
  head: () => ({
    meta: [
      { title: "Free Bank Statement to OFX Converter — LedgerLocal" },
      ...
      { property: "og:title", content: "Free Bank Statement to OFX Converter — LedgerLocal" },
    ],
  }),
  component: Page,
});
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-6 pb-4">
        <Link to="/upload" className="inline-flex items-center gap-2 rounded-md bg-ink px-6 py-3 text-sm font-semibold text-background transition hover:bg-ink/90">
          Convert a statement to OFX <ArrowRight className="h-4 w-4" />
        </Link>
